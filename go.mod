module github.com/SlothNinja/user_service
...
require (
	...
	github.com/SlothNinja/user v0.0.10
...
replace github.com/SlothNinja/user v0.0.10 => /Volumes/Janice/git-projects/user
